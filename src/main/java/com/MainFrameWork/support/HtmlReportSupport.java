...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport() throws Exception {
		...
		try {
			...
			writer.write("<title>Worldline - Automation Execution Results Summary</title>");
			...
			writer.write("Worldline -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
	...
	public static void onFailure(String strStepName, String strStepDes) {
		...
		try {
			...
			// added by rohan
			try {
				Reporter.takescreenshotOnFailure();
			} catch (Throwable e) {
	...
	public static void reportStep(String StepDesc) {
		...
		File file = new File(TestEngine.filePath() + "/" + strTestName+"_Results_"
				+ TestEngine.timeStamp + ".html");// "SummaryReport.html"
		Writer writer = null;
		TestEngine.test.log(LogStatus.INFO, StepDesc);
