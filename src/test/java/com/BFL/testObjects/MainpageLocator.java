...
public static final By BlockCategory  = By.xpath("//a[contains(text(),'Block Category ')]");
...
public static final By AccountId=By.xpath(".//*[@id='ContentPlaceHolder1_ddlAccountnumbers']");
public static final By OnlineRequest=By.linkText("Online Request");
public static final By SystemBlockcode=By.id("txtSystemBlockCode");
public static final By ManualBlockcode=By.id("txtManualBlockCode"); 
public static final By EnterJSON=By.id("ContentPlaceHolder1_txtClearJSON");
